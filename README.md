...
|----------------------------------------------|
| **Sólo permite la apertura remota.** — apertura a ciegas, es tu responsabilidad decidir cuándo abrir.|
...
El Fermax 9445 tiene botones físicos en la placa: uno de ellos sirve para activar la **cámara** y el de la **llave** sirve para abrir la puerta.
...
De esta manera, podremos simular las pulsaciones de ambos botones y realizar la apertura de la puerta en remoto siguiendo el siguiente flujo:
...
Se utiliza script de HA que abre la puerta cuando se dispara manualmente. Simplemente acciona el botón de la cámara, espera durante 1 segundo y acciona el botón de la llave.

<img src="fotos/script.png">

---

## ☕ Apoya el proyecto

Este proyecto es gratuito y seguirá siéndolo.

Si te ha ayudado y quieres agradecer el tiempo invertido en su desarrollo, puedes hacer una aportación voluntaria:

💙 https://www.paypal.com/paypalme/rubengonzalez96
